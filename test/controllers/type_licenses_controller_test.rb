...
class TypeLicensesControllerTest < ActionController::TestCase
  ...
  test "should create type_license" do
    assert_difference('TypeLicense.count') do
      post :create, type_license: { duration: @type_license.duration, name: @type_license.name, version: @type_license.version }
    end
  ...
  test "should update type_license" do
    patch :update, id: @type_license, type_license: { duration: @type_license.duration, name: @type_license.name, version: @type_license.version }
    assert_redirected_to type_license_path(assigns(:type_license))
  end
